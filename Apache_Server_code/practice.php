  ...
  <script>  //수정(checkBtn) 버튼 동작
    $("#checkBtn").submit(function(){
      ...
      function checkBtn(){
        ...
        $update_value_todo = $_POST['data_todo'];
        $update_value_date = $_POST['data_date'];
        $update_value_done = $_POST['data_done'];
     ...
     //$(document).on('submit', '#delBtn', function(event) {  //on()을 이용한 jqurey
      $("#delBtn").submit(function(){   //.submit()을 이용한 jqurey, 둘 다 사용 가능
        ...
        function deleteBtn(){
          ...
          $delete_value_todo = $_GET['data_todo'];
          $delete_value_date = $_GET['data_date'];
