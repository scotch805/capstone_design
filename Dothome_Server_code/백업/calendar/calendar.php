<head>
  ...
  <?php   //db연결 및 쿼리(Todo 값을 모두 가져옴)
    $host = "localhost";
    $username = "pilladvisor";
    $password = "q1w2e3r4!";
    $database_name = "pilladvisor";        
  ...
  <div class="lacation2"> <!--다이어리 만들 위치-->
    ...
    <!-- 여기서부터 Todo -->
      <div class="todo-wrapper">    <!--CRUD 작성하기 -->
        ...
        <div class="todo-box">
              <div class="todo-top">
                <button class="left-items" onclick="location.href='http://pilladvisor.dothome.co.kr/calendar/calendar.php'">오늘로 가기</button>
