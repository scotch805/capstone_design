...
<head>
    ...
    <style>
        ...
        .info_box{display:flex; flex-direction: column;justify-content:space-between;
            width: 90%;margin: 0 auto;  height:180px;}
        .info_box .title{position:relative; height:78%; text-align: center; cursor:pointer; }
        .info_box .login {height:22%;text-align: right;cursor:pointer;}
        .title_name{ position:absolute;font-weight:300;font-size: 45px;bottom:0%;left: 50%;transform: translate(-50%, 0%);}
        button {
            margin-top: 10px;
            padding: 5px 10px;
...
<body>
    ...
    <div class="container">
        ...
        <select id="drugSelect" class="form-select" style="display:block;">
        ...
        <script>
            ...
            /*howDropdownButton.addEventListener('click', function () {
