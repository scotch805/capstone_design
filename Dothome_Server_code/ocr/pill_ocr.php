...
<head>
    ...
    <script>
        ...
        function addRecentResult(result) {
            ...
            resultItem.innerHTML = `
                ...
                <div class="button-container">
                    ...
                    <button onclick="addMedicineToDB('${result.chatgpt_result}')">추가</button>
                </div>
        ...
        function fetchPillInfo(event, query) {
            ...
            const pillInfoDiv = button.closest('.result-item').querySelector('.pill-info');
        ...
        function addMedicineToDB(medicineName) {
            fetch('add_medicine_ajax.php', {
                method: 'POST',
                headers: {
                    'Content-Type': 'application/json'
                },
        ...
        <div class="sidebar-content">
            ...
            if (file_exists('result.json')) {
                ...
                foreach ($existing_data as $index => $result) {
                    ...
                    echo '<button onclick="addMedicineToDB(\'' . htmlspecialchars($result['chatgpt_result']) . '\')">추가</button>';
                    echo '</div>';
